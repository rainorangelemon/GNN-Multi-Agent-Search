...
def main():
    ...
    # ID_map, ID_graph, ID_CASE, numAgent = 997, 0, 0, 4

    # ID_map, ID_graph, ID_CASE, numAgent = 997, 0, 0, 4
    ID_map, ID_graph, ID_CASE, numAgent = 238, 0, 0, 5
    # ID_map, ID_graph, ID_CASE, numAgent = 2356, 0, 0, 5
...
#                       "save_animation": "/home/qingbiao/PycharmProjects/GNN_MultiAgentSearch/results/animation/",
    ...
    # path_file_optimal = dir_dataset_sol_dir/f'BoxEnv_ID_map_{ID_map:03d}_ID_graph_{ID_graph:03d}_ID_case_{ID_CASE:03d}_numAgent_{numAgent:03d}.optimal'

    path_file_graph = dir_dataset_sol_dir/f'BoxEnv_ID_map_{ID_map:03d}_ID_graph_{ID_graph:03d}_ID_case_{ID_CASE:03d}_numAgent_{numAgent:03d}.graph'

    import pickle
    # with open(path_file_optimal, "rb") as file:
    #     data_dict_optimal = pickle.load(file)
    ...
    while True:
        ...
        # print(state)
        finish, collsion = env.step_state(state, blocks.simulator_.global_time_)
        # env.render()
        # breakpoint()
        ...
        if blocks.reached_goal():
            ...
            print(env.agents_flowtime, env.agents_makespan)
            break
